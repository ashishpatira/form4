...
def download_and_parse_filing(cik: str, filing_info: Dict) -> str:
    ...
    try:
        ...
        # Using native lxml.html.fromstring instead of BeautifulSoup for significant
        # performance improvement when parsing large SEC filings.
        ...
        # Extract text using itertext to preserve spaces between adjacent tags
