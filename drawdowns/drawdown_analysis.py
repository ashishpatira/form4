...
def simulate_timeseries(days=5000, initial_price=100.0, drift=0.1, annualized_volatility=0.20):
    ...
    # Vectorize the simulation using cumprod for significant performance gains
    # The formula is: Price[t] = Price[0] * cumprod(1 + drift/252 + noise)
    ...
    # for realistic inputs and is much faster
