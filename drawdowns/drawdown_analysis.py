...
def simulate_timeseries(days=5000, initial_price=100.0, drift=0.1, annualized_volatility=0.20):
    ...
    # Vectorized simulation using np.cumprod for optimal performance
    # applying np.maximum at the end is functionally equivalent to step-by-step flooring for realistic inputs
    daily_returns = 1 + drift/252 + noise
